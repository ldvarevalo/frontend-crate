...
const SelectItem = ({
  ...
  <SelectPrimitive.Item
    ...
    className={cn(
      'relative flex w-full cursor-default items-center gap-1.5 rounded-md py-3 pr-8 pl-1.5 text-sm outline-hidden select-none focus:bg-accent focus:text-accent-foreground not-data-[variant=destructive]:focus:**:text-accent-foreground data-[selected]:text-primary data-[selected]:focus:bg-primary/20 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*=\'size-\'])]:size-4 [&_svg]:text-primary *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2',
      className
    )}
    {...props}
  >
